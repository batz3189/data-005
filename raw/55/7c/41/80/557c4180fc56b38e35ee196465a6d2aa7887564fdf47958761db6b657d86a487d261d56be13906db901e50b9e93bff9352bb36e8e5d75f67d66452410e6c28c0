...
%
%   PATCHGENERATOR - the mesh is not refined close to the feed(s)
%   PATCHGENERATOR2 - the mesh is refined close to the feed(s)
%
...
L=0.40;     %Plate length (along the x-axis)
W=0.80;     %Plate width (along the y-axis)
Nx=8;       %Discretization parameter (length)
Ny=12;      %Discretization parameter (width)
...
%Mesh refinement close to the probe feed
%(this code is equivalent to that in Section 10.9)
x=[0.092 0.108 0.100 0.100];
y=[0.166 0.166 0.182 0.150];
X=[X x];
Y=[Y,y];
